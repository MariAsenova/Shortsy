...
public class Token {
    ...
    private static final TokenKind[] KEYWORDS = { DECLARE, DO, ELSE,  FUNC, IF,  RETURN, SAY, THEN, WHILE,VOID,INTEGER,BOOLEAN,INPUT,OUTPUT,ASSIGNMENT_OPERATOR, COMMA, SEMICOLON, LEFTPARAN, RIGHTPARAN, RIGHTBRACES, LEFTBRACES, INTEGERLITERAL,BOOLEANLITERAL};
